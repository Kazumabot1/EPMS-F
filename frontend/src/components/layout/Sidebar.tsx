    ...
    const navItems: NavItem[] = useMemo(() => {
        ...
        const hrNavItems: NavItem[] = [
            ...
            },
            {
                ...
                children: [
                    { to: '/hr/feedback/questions', label: 'Question Bank', icon: 'bi bi-journal-text' },
                    { to: '/hr/feedback/question-rules', label: 'Question Rules', icon: 'bi bi-funnel' },
                    ...
                    { to: '/hr/feedback/assignment-preview', label: 'Assignment Preview', icon: 'bi bi-clipboard-check' },
