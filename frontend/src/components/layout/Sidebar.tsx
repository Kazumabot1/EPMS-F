  ...
  const navItems: NavItem[] = useMemo(() => {
    ...
    const adminNavItems: NavItem[] = [
      ...
      { to: '/admin/employee/import', label: 'Import Accounts', icon: 'bi bi-upload' },
      {
        ...
        icon: 'bi bi-shield-lock',
        children: [
          { to: '/admin/roles', label: 'Roles', icon: 'bi bi-person-badge' },
          { to: '/user-roles', label: 'User Roles', icon: 'bi bi-person-gear' },
          { to: '/role-permissions', label: 'Role Permissions', icon: 'bi bi-shield-check' },
          { to: '/permissions', label: 'Permissions', icon: 'bi bi-key' },
        ],
    ...
    const hrNavItems: NavItem[] = [
      ...
      },
      {
        ...
        children: [
          ...
          { to: '/hr/employee', label: 'Employee', icon: 'bi bi-people', end: true },
          { to: '/hr/audit-logs', label: 'Audit Logs', icon: 'bi bi-clock-history', end: true },
          {
            to: '/hr/employee/workforce',
            label: 'Workforce overview',
            icon: 'bi bi-person-badge',
...
const Sidebar = ({ collapsed, onToggle, variant }: SidebarProps) => {
  ...
  const isAdmin = normalizedRoles.includes('ADMIN') || dashboard === 'ADMIN_DASHBOARD';
  const isEmployee = normalizedRoles.includes('EMPLOYEE') || dashboard === 'EMPLOYEE_DASHBOARD';
  ...
  const navItems: NavItem[] = useMemo(() => {
    ...
    const adminNavItems: NavItem[] = [
      ...
      },
      {
        ...
        icon: 'bi bi-building',
        children: [
          { to: '/admin/department', label: 'Departments', icon: 'bi bi-building', end: true },
          { to: '/admin/audit-logs', label: 'Audit Logs', icon: 'bi bi-clock-history', end: true },
        ],
      },
      {
        to: '/admin/position',
        ...
        icon: 'bi bi-briefcase',
        children: [
          { to: '/admin/position/create', label: 'Create Position', icon: 'bi bi-briefcase' },
          { to: '/admin/position-level/create', label: 'Position Levels', icon: 'bi bi-diagram-3' },
          { to: '/admin/position/table', label: 'Positions Table', icon: 'bi bi-table' },
        ],
      },
      {
        to: '/pip',
    ...
    const hrNavItems: NavItem[] = [
      ...
      {
        to: '/hr/assessment-score-table',
        label: 'Assessment',
        icon: 'bi bi-clipboard-data',
        children: [
          { to: '/hr/assessment-score-table', label: 'Scores', icon: 'bi bi-clipboard-data', end: true },
          { to: '/hr/assessment-form', label: 'Form Create', icon: 'bi bi-ui-checks-grid', end: true },
        ],
      },
      {
        to: '/hr/appraisal',
      ...
      },
      {
        ...
        icon: 'bi bi-speedometer2',
        children: [
          { to: '/hr/kpi/units', label: 'KPI Units', icon: 'bi bi-speedometer2' },
          { to: '/hr/kpi/categories', label: 'KPI Categories', icon: 'bi bi-tags' },
          { to: '/hr/kpi/items', label: 'KPI Items', icon: 'bi bi-card-checklist' },
          { to: '/hr/kpi/templates', label: 'KPI Templates', icon: 'bi bi-ui-checks-grid' },
        ],
      },
    ];
