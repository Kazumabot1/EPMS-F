      ...
      >
        ...
        <div className="epms-emp-form-body max-h-[60vh] overflow-y-auto px-4 pb-4">
          <dl className="epms-emp-dl epms-emp-dl-2">
            ...
            <div>
              <dt>Date of birth</dt>
              <dd>{employee.dateOfBirth ? formatDateForInput(employee.dateOfBirth) : '—'}</dd>
            </div>
            ...
            <div>
              ...
              <dd>{display(employee.currentDepartment)}</dd>
            </div>

            <div>
              <dt>Parent Department</dt>
              <dd>{display(employee.parentDepartment)}</dd>
            </div>

            <div>
              <dt>Working Department</dt>
              <dd>{display(employee.workingDepartment ?? employee.parentDepartment ?? employee.currentDepartment)}</dd>
            </div>
          </dl>
          ...
          {employee.userId != null && employee.userId !== undefined && employee.email?.trim() ? (
            <div className="epms-emp-form-section">
              ...
              <p className="text-sm text-slate-600">
                Resend the temporary password message after fixing SMTP.
              </p>
