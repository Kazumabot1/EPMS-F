...
/*
  Why this file is updated:
  - Department Head now has One-on-One in the left sidebar.
  - PIP remains available for Manager and Department Head.
*/
/*
export type UserRole =
  | 'Employee'
...
DepartmentHead: [
  ...
  },
  {
    ...
    icon: 'bi-people-fill',
    children: [
      { label: 'Teams', path: '/department-head/teams', icon: 'bi-people-fill' },
      { label: 'Create Team', path: '/department-head/teams/create', icon: 'bi-plus-square' },
      { label: 'Team History', path: '/department-head/team-history', icon: 'bi-clock-history' },
    ],
  },
  { label: 'Assessment Scores', path: '/hr/assessment-scores', icon: 'bi-clipboard-data' },
  {
