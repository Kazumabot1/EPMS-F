...
export const roleNavigation: Record<UserRole, NavItem[]> = {
  ...
  HR: [
    ...
    { label: 'Assessment Forms', path: '/hr/assessment-forms', icon: 'bi-ui-checks-grid' },
    {
      ...
      children: [
        { label: 'Appraisal Cycle Dashboard', path: '/hr/appraisal', icon: 'bi-speedometer2', end: true },
        { label: 'Template Forms', path: '/hr/appraisal/template-forms', icon: 'bi-folder2-open' },
        { label: 'Appraisal Cycles', path: '/hr/appraisal/cycles', icon: 'bi-calendar2-week' },
