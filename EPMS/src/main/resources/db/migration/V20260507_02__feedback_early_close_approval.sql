-- Controlled early close approval workflow for 360 feedback campaigns.
-- HR may request early close before deadline only when all evaluators submitted;
-- Admin approval closes the campaign and records review details.
